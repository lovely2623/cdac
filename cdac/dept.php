...
// Check if the course already exist.
    $checkSql = $conn->prepare("SELECT * FROM departments WHERE Department = '$deptName'");
    $checkSql->execute();
    ...
    if ($result->num_rows>0){
        ...
        //insert new records
        $insertSql = $conn->prepare("Insert Into departments(Department) VALUES ('$deptName')");
...
<h2>Welcome! <br/><br/> <?php echo isset($_SESSION['name']) ? $_SESSION['name'] : ''; ?> (Admin !)</h2>
    <button type="submit" class="buton prev btn-primary"> <a href= "deptdetails.php">Previous</a></button>
...
<div class="containercourse">
        ...
        <form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
                <label for="deptName">Department Name:-</label><br/><br/>
